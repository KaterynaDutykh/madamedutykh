...
{{< admonition example "Возможно, сложно сразу понять, поэтому приведу пример:" false >}}
...
{{< admonition type=info title="Ставки налообложения 2015" open=false >}}

***Ставки налообложения 2015:***
...
{{< style align="center" >}}
{{< figure src="/images/post-10-french-income/fCarte-France-Salaires.jpg" >}}
{{< /style >}}
