...
{{ $img := resources.Get "images/post-11-french-elections/img_20170423_141837.jpg" | resources.Resize "800x" }}
...
<div style="display: flex; align-items: flex-start; gap: 20px; margin-bottom: 2em;">
 ...
 <!-- Правая часть: картинка и подпись -->
  <div style="flex: 0 0 45%; text-align: center;">
    <img src="{{ $img.RelPermalink }}" alt="Фото карточки избирателя" style="max-width: 100%; height: auto; display: block; margin: 0 auto;">
    <div style="font-size: 0.8em; margin-top: 0.5em;">
      На оборотной стороне указаны личные данные избирателя, его номер в списке, место голосования и подпись/печать мэра
    </div>
  </div>
</div>
{{< /style >}}
