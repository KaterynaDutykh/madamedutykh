...
<div style="display: flex; align-items: flex-start; margin-bottom: 2em;">
  ...
  <div style="flex: 0 0 45%;">
    <img src="/images/post-11-french-elections/img_20170423_141837.jpg" style="max-width: 100%; height: auto;" alt="Фото карточки избирателя">
    <p style="font-size: 0.8em; margin-top: 0.5em;">На оборотной стороне указаны личные данные избирателя, его номер в списке, место голосования и подпись/печать мэра</p>
  </div>
</div>
